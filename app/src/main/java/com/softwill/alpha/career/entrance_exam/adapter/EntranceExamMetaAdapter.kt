...
class EntranceExamMetaAdapter(
    private val mList: ArrayList<MetaDataModel>,
    private val context: Context,
    private val callbackInterface: EntranceExamMetaCallbackInterface,
) :
    RecyclerView.Adapter<EntranceExamMetaAdapter.ViewHolder>() {
    ...
    interface EntranceExamMetaCallbackInterface {
