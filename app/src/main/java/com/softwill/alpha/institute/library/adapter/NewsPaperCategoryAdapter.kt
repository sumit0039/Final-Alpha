...
class NewsPaperCategoryAdapter(
    private var mList: ArrayList<NewsPaperCategories>,
    private val context: Context,
    private val callbackInterface: NewsPaperCategoryCallbackInterface,
    var clickPosition: Int = 0,
) :
    RecyclerView.Adapter<NewsPaperCategoryAdapter.ViewHolder>() {
        ...
        with(holder) {
            with(mList[position]) {
                ...
                binding.root.setOnClickListener {
                    callbackInterface.newsPaperCategoryClickCallback(categoryId, position)
    ...
    fun updateClickPosition(newClickPosition: Int) {
    ...
    interface NewsPaperCategoryCallbackInterface {
        fun newsPaperCategoryClickCallback(categoryId: Int, position: Int)
    }
}