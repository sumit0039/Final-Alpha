...
class FacilitiesCanteenAdapter(
    private val context: Context,
    private var mList: ArrayList<CanteenFacility>,
) :
    RecyclerView.Adapter<FacilitiesCanteenAdapter.ViewHolder>() {

    var mFacilityAdapter: FacilityAdapter? = null

    override fun onCreateViewHolder(
        parent: ViewGroup, viewType: Int
    ): FacilitiesCanteenAdapter.ViewHolder {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        with(holder) {
            with(mList[position]) {
                ...
                mFacilityAdapter = FacilityAdapter(context, facilities)
